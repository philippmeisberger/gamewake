...
begin
  try
    ...
    FLang.MessageBox(Format(FLang.GetString(76), [FConfigPath]), mtError);
  end;  //of try
end;
...
begin
  // Show confirmation
  with FLang do
    if (MessageBox(GetString(69) +^J+ GetString(70), mtQuestion) = IDYes) then
    begin
      bStop.Click;
      Close;
    end;  //of begin
...
begin
  ...
  try
    ...
    FLang.MessageBox(Format(FLang.GetString(62), [Clock.Alert.GetTime(False)]));
